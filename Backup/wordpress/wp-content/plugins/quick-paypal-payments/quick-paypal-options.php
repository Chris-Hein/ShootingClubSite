...
function qpp_get_stored_options($id) {
    ...
    $default = array(
        'sort' => 'field1,field4,field19,field2,field3,field5,field6,field7,field9,field12,field13,field14,field11,field8,field10,field15,field16,field17,field18,field19,field21,field22',
        'title' => 'Payment Form',
        ...
        'use_cf' => '',
        'ruse_cf' => '',
        'consentlabel' => 'I consent to my data being retained by the site owner after payment has been processed.',
        'use_consent' => '',
        'optionlabel' => 'Options',
    ...
    if (!strpos($qpp['sort'],'field21')) $qpp['sort'] = $qpp['sort'].',field21';
    if (!strpos($qpp['sort'],'field22')) $qpp['sort'] = $qpp['sort'].',field22';
    return $qpp;
}
